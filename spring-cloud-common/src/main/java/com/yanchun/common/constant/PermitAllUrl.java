package com.yanchun.common.constant;
...
public final class PermitAllUrl {
     ...
     */
    private static final String[] ENDPOINTS = {"/verification/**","/user/**","/actuator/health", "/actuator/env", "/actuator/metrics/**", "/actuator/trace", "/actuator/dump",
