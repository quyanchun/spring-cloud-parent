package com.yanchun.common.sourcegenerator.utils;
...
public class GeneratorConfiguration {
    ...
    public GeneratorConfiguration(final Class<?> modelClazz, final String outputType, final String outputDir,
        ...
        final int indexOfModelEntity = modelFullname.indexOf(".entity");
        final int indexOfModelModel = modelFullname.indexOf(".entity");
